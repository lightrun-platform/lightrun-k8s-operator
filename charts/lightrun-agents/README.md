...
| `javaAgents[].workloadName`                        | Name of the Kubernetes workload (Deployment or StatefulSet) to attach the Lightrun Java Agent.                                                                                                                                                  | Required                                                        |
| `javaAgents[].workloadType`                        | Type of the Kubernetes workload. Must be either `"Deployment"` or `"StatefulSet"`.                                                                                                                                                              | Required                                                        |
...
- The `my-service-1` targets a Deployment and does not use an `existingSecret`
- The `my-service-2` targets a StatefulSet and uses an `existingSecret` named `my-existing-secret`
...
- The `my-service-1` targets a Deployment with full configuration options
- The `my-service-2` targets a StatefulSet with an `existingSecret`
